<?php
// ZDE JE NASTAVENI PROPOJENI DO DATABAZE
// ZDE ZMENNE POUZE NA VASI DB!
...
/**
 * V mainModelu jsou funkce pro praci s DB (od p.Dostala :D) zde toho moc psat nemusite
 * veskere vlastni funkce piste do Model.php
 */
class MainModel {
